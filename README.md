...
## PUT:
 ...
 -
 La explicación a continuación fue tomada del archivo README.md del repositorio https://github.com/holgiosalos/workshop-api-testing-js/blob/master/README.md
 -
...
1. Borrar la rama y actualizar tu local con los cambios mergeados `git checkout master && git pull`
